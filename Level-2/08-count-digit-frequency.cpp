...
int PrintDigits(int Number, int Digit)
{
    int reminder = 0;
    int count = 0;
    while (Number > 0)
...
int main()
{
    int PositiveNumber = ReadPositiveNumber("Enter a Positive Number ?");
    int PositiveDigit = ReadPositiveNumber("Enter a Positive Digit ?");
    cout << "Digit " << PositiveDigit << " Frequency is " << PrintDigits(PositiveNumber, PositiveDigit) << " Time";
    return 0;
}
